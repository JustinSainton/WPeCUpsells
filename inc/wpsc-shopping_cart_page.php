...
.div_naveed { background-color:#E9E9E9; padding: 10px; font-size: 18px; color:#000000; width: 738px; }
#current_country { padding-left:5px; padding-right:5px; margin-right:15px; }
#region { padding-left:5px; padding-right:5px;  }
</style>
<?php
...
?>
<div style="margin-top:-60px; width:105%; clear:none; background-color:#FFFFFF;" id="checkout_page_container">
<h3><?php _e('Please review your order', 'wpsc'); ?></h3>
<table class="checkout_cart">
   <tr >
    <td width="30%">&nbsp;</td>
    <td  width="25%" style="padding-top:5px; padding-bottom:5px;"><span style="color:#FE7800; text-transform:uppercase;"><strong><?php _e('Product', 'wpsc'); ?></strong></span></td>
    <td  width="11%"  style="padding-top:5px; padding-bottom:5px;"><span style="color:#FE7800; text-transform:uppercase;"><strong><?php _e('Quantity', 'wpsc'); ?></strong></span></td>
    <td  width="8%"  style="padding-top:5px; padding-bottom:5px;"><span style="color:#FE7800; text-transform:uppercase;"><strong><?php _e('Price', 'wpsc'); ?></strong></span></td>
    <td  width="9%"  style="padding-top:5px; padding-bottom:5px;"><span style="color:#FE7800; text-transform:uppercase;"><strong><?php _e('Total', 'wpsc'); ?></strong></span></td>
    <td width="9%">&nbsp;</td>
    <td width="8%">&nbsp;</td>
  </tr>
   <?php while (wpsc_have_cart_items()) : wpsc_the_cart_item(); ?>
      ...
      <tr style="background-color:#F2F2F2; border:#666666 1px solid;" class="product_row product_row_<?php echo wpsc_the_cart_item_key(); ?> <?php echo $alt_class;?>">
         ...
         <td class="wpsc_product_quantity wpsc_product_quantity_<?php echo wpsc_the_cart_item_key(); ?>">
            <form action="<?php echo get_option('shopping_cart_url'); ?>" method="post" class="adjustform qty">
               <input type="text" name="quantity" size="2" value="<?php echo wpsc_cart_item_quantity(); ?>" style="width:50px;" /><br />
<input type="submit" value="<?php _e('Update', 'wpsc'); ?>" name="submit"  style="background-color: black;
    border: medium none;
    ...
    width: 60px;" />
         ...
         <td class="wpsc_product_remove wpsc_product_remove_<?php echo wpsc_the_cart_item_key(); ?>">
            <form action="<?php echo get_option('shopping_cart_url'); ?>" method="post" class="adjustform remove">
               ...
               <input type="hidden" name="key" value="<?php echo wpsc_the_cart_item_key(); ?>" />
               <input type="hidden" name="wpsc_update_quantity" value="true" />
               <input type="submit" value="<?php _e('Remove', 'wpsc'); ?>" name="submit" style="background-color: black;
    border: medium none;
    border-radius: 11px 11px 11px 11px;
    color: white;
    font-size: 10px;
...
<tr class="3">&nbsp;</tr>
      ...
      <td width="34%"><span style="color:#FE7800; text-transform:uppercase;"><?php _e('Enter Coupon Code', 'wpsc'); ?></span></td>
         <td  colspan="4" class="coupon_code">
            <form  method="post" action="<?php echo get_option('shopping_cart_url'); ?>">
               <input type="text" name="coupon_num" id="coupon_num" value="<?php echo $wpsc_cart->coupons_name; ?>" style="width:200px; float:left"/>
               <input type="submit" value="<?php _e('Update', 'wpsc') ?>"  style="background-color: black;
    border: medium none;
    border-radius: 11px 11px 11px 11px;
    color: white;
    float: left;
    ...
    width: 76px;"/>
 	...
 	<tr class="wpsc_total_before_shipping">
		<td><span style="color:#FE7800;  font-size: 10px; text-transform:uppercase;"><?php _e('All promotion purchases are final sale. Please review your order, size, color and details carefully. All orders will ship within 5-10 work days.','wpsc'); ?></span></td>
	</tr>
      <tr class="wpsc_total_before_shipping">
	  <td><span style="color:#FE7800;  font-size: 11px; text-transform:uppercase;"><?php _e('Cost before shipping:','wpsc'); ?></span></td>
	     <td align="left"><strong><?php echo wpsc_cart_total_widget(false,false,false);?></strong></td>
    <td>&nbsp;</td>
      </tr>

     <?php if(wpsc_uses_coupons() && (wpsc_coupon_amount(false) > 0)): ?>
     <tr class="total_price">
         <td class='wpsc_totals' align="left"  style="padding-left:0px;">
           <span style="color:#FE7800; text-transform:uppercase;"> <?php _e('Discount', 'wpsc'); ?>:</span>&nbsp;&nbsp;<span id="coupons_amount" class="pricedisplay"><strong><?php echo wpsc_coupon_amount(); ?></strong></span>
         </td>
  ...
  <?php if(wpsc_uses_shipping()): ?>
   ...
   ?>
   <?php dynamic_sidebar( 'Below Coupon Code' ); ?>
   <?php do_action('wpsc_before_shipping_of_shopping_cart'); ?>

   <div id="wpsc_shopping_cart_container" style="padding-top:20px;">
   <?php if(wpsc_uses_shipping()) : ?>
   <div class="div_naveed">
     <?php _e('Calculate Shipping Price', 'wpsc'); ?></div>
    	  <table width="100%" border="0" cellpadding="5" cellspacing="5">
         <tr><td colspan="2">&nbsp;</td></tr>
  <tr>
            <td width="55%">
              <span style="color:#FE7800; font-size:11px; text-transform:uppercase;"> <?php _e('Please choose a country below to calculate your shipping costs', 'wpsc'); ?>
            </span></td>
         </tr>
<td width="45%">
	<table width="100%" border="0" cellpadding="5" cellspacing="5">
        ...
        <tr>
            <td colspan='5'>
               <form name='change_country' id='change_country' action='' method='post'>
                  ...
                  <input type='submit' name='wpsc_submit_zipcode' value='Calculate' style="background-color: black;
    border: medium none;
    border-radius: 11px 11px 11px 11px;
    color: white;
    float: right;
      ...
      <table class="productcart">
         <tr class="total_price total_tax">
            <td width="55%" style="padding-left:0px;">
               <span style="color:#FE7800;  font-size: 11px; text-transform:uppercase;">  <?php echo wpsc_display_tax_label(true); ?></span>            </td>
            <td colspan="2">
        ...
        <?php if(wpsc_checkout_form_is_header() == true){
               ...
               <tr <?php echo wpsc_the_checkout_item_error_class();?>>
                  <td <?php wpsc_the_checkout_details_class(); ?> colspan='2'>
                     <div class="div_naveed"><?php echo wpsc_checkout_form_name();?></div>
                  </td>
               </tr>
			    <tr><td colspan="2">&nbsp;</td></tr>
            ...
            <?php
               ...
               <?php $email_markup ="<div  class='wpsc_email_address' style='padding-top:30px;'>
                      <p class='" . wpsc_checkout_form_element_id() . "' style='width:250px;'>
...
?>
      ...
      <?php if(wpsc_uses_shipping()) : ?>
	      <tr>
	         <td class='wpsc_total_price_and_shipping' colspan='2'>
	            <div class="div_naveed"><?php _e('Review and purchase','wpsc'); ?></div>
	         </td>
	      </tr>

	      <tr class="total_price total_shipping">
	          <td class='wpsc_totals' align="left" style="padding-left:0px;">
	           <span style="color:#FE7800; text-transform:uppercase;"> <?php _e('Total Shipping', 'wpsc'); ?>:</span>&nbsp;&nbsp;
			   <span id="checkout_shipping" class="pricedisplay checkout-shipping"><strong><?php echo wpsc_cart_shipping(); ?></strong></span>
	         </td>
   ...
   <tr class='total_price'>
      <td class='wpsc_totals' align="left"  style="padding-left:0px;">
      <span style="color:#FE7800; text-transform:uppercase;"><?php _e('Total Price', 'wpsc'); ?>:</span>&nbsp;&nbsp;<span id='checkout_total' class="pricedisplay checkout-total"><strong><?php echo wpsc_cart_total(); ?></strong></span>
      </td>
      <td class='wpsc_totals'>
      ...
      <div class='wpsc_make_purchase'>
         <span>
            ...
            <?php endif; ?>
               ...
               <input type='submit' value='<?php _e('Purchase', 'wpsc');?>' name='submit' class='make_purchase wpsc_buy_button' style="background-color: black;
    border: medium none;
    border-radius: 11px 11px 11px 11px;
    color: white;
    font-size: 14px;
