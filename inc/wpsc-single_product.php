...
a.button, input[type="submit"] {
    background: none repeat scroll 0 0 #ABCACD;
...
.wpsc_variation_forms table tr td.col1
{
	width: 13%;
}
#menu_wrapper {
...
.single single-wpsc-product postid-1324 single-format-standard logged-in admin-bar
{
display:none;}
.widget_text {
...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					<div class="imagecol" style="width:306px; border:solid 4px #FFFFFF; margin-top:22px;">
						<?php if ( wpsc_the_product_thumbnail() ) : ?>
								...
								if ( function_exists( ‘gold_shpcrt_display_gallery’ ) )
									echo 'gold cart display reached successfully';
					...
					<div class="productcol" style="margin-left: 320px;width: 305px; margin-top:29px;font-size:12px;">
						<?php do_action('wpsc_product_before_description', wpsc_the_product_id(), $wp_query->post); ?>
						<div class="product_description" style="font-size:12px;">
							<?php echo wpsc_the_product_description(); ?>
						</div><!--close product_description -->
						<?php do_action( 'wpsc_product_addons', wpsc_the_product_id() ); ?>
						<?php if ( wpsc_the_product_additional_description() ) : ?>
							<div class="single_additional_description" style="font-size:12px;">
						...
						<div class="custom_meta">
							...
							<?php
								if ( 'ivycat_slider_order' == wpsc_custom_meta_name() )
									continue;
							?>
						...
						<form class="product_form" enctype="multipart/form-data" action="<?php echo wpsc_this_page_url(); ?>" method="post" name="1" id="product_<?php echo wpsc_the_product_id(); ?>">
							...
							<?php if ( wpsc_product_has_personal_text() ) : ?>
								<fieldset class="custom_text">
									...
									<p><?php _e( 'Please enter engraving text here exactly as you would like it engraved.  i.e. monogram - sMf.', 'wpsc' ); ?></p>
						...
						<?php /** the variation group HTML and loop ends here */?>
							...
							<?php endif ;?>
							<div class="wpsc_product_price" style="color:#FE7800;">
...
<span class='st_facebook_buttons' st_title='<?php the_title(); ?>' st_url='<?php the_permalink(); ?>' displayText='share'></span><span class='st_twitter_buttons' st_title='<?php the_title(); ?>' st_url='<?php the_permalink(); ?>' displayText='share'></span>
<span class='st_email_buttons' st_title='<?php the_title(); ?>' st_url='<?php the_permalink(); ?>'displayText='share'></span>
<span class='st_pinterest_buttons' st_title='<?php the_title(); ?>' st_url='<?php the_permalink(); ?>' displayText='share'></span>
						<!--close product_form-->
